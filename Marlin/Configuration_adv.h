/**
 * Marlin 3D Printer Firmware - optimized ender 3 v3 se
...
#else
  #define BLOCK_BUFFER_SIZE 64  // AUMENTADO: era 16, agora 64 para resolver stutter
#endif
...
#define BUFSIZE 64  // AUMENTADO: era 16, agora 64 para resolver stutter
